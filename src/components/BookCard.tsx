    ...
    >
      <Link to="/book/$id" params={{ id: book.id }} className="block">
        <div className="relative">
          ...
          <span className="absolute right-2 top-2 grid h-9 w-9 place-items-center rounded-full bg-background/80 opacity-0 backdrop-blur transition-all group-hover:opacity-100" aria-label="Quick view">
